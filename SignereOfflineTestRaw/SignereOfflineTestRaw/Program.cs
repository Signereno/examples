    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            NewDocument document = new NewDocument()
            {
                ...
                SigneeRefs =
                   new List<SigneeRef>()
                   {
                        new SigneeRef()
                        {
                            ...
                            Email = "Enter signee's email address to receive signing link",
                            Mobile = "Enter signee's phone number to receive SMS notification, including country code (+XXX)",
                            FirstName = "John",
                            LastName = "Doe"
                        }
                   },
                CreatePADES = true,
                MessageEmail = "Hi! You have received a document to sign. Press the link below to sign",
                MessageSms = "Hi! You have received a document to sign. Please check your e-mail.",
                SenderEmail = "test@test.com",
                SenderMobile = "+4799999999",
                TopicEmail = "Document to sign",
                ...
                Private = false,
                ReceiptMessageEmail = "receipts@test.com",
                ReceiptTopicEmail = "Test document has been signed",
